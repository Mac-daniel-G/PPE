...
// Récupérer les programmes spécifiques pour la cardio
$cardioProgrammes = ProgrammeController::getProgrammesByType('cardio');

?>

<div class="container">
    <h1 class="text-center mt-4">Programmes de Cardio</h1>
    <?php if (!empty($cardioProgrammes)) : ?>
        <div class="row">
            <?php foreach ($cardioProgrammes as $programme) : ?>
    ...
    <?php else : ?>
        <p class="text-center">Aucun programme de cardio disponible pour le moment.</p>
    <?php endif; ?>
</div>
