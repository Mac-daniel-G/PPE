...
// Récupérer les programmes spécifiques pour la yoga
$yogaProgrammes = ProgrammeController::getProgrammesByType('yoga');
?>

<div class="container">
    <h1 class="text-center mt-4">Programmes de yoga</h1>
    <?php if (!empty($yogaProgrammes)) : ?>
        <div class="row">
            <?php foreach ($yogaProgrammes as $programme) : ?>
    ...
    <?php else : ?>
        <p class="text-center">Aucun programme de yoga disponible pour le moment.</p>
    <?php endif; ?>
</div>
