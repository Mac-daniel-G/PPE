...
<div class="container mt-5">
    ...
    <div class="jumbotron text-center bg-light p-5 rounded">
        ...
        <a href="../View/programmes/index.php" class="btn btn-primary btn-lg">Découvrir nos programmes</a>
        <a href="../View/connexion.php" class="btn btn-secondary btn-lg">Se connecter</a>
    </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="../View/programmes/index.php" class="btn btn-primary">En savoir plus</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
    ...
    <section class="mt-5">
        ...
        <div class="text-center">
            <a href="../View/salle.php" class="btn btn-success btn-lg">Voir les Salles</a>
        </div>
    </section>
    ...
    <section class="mt-5 bg-light p-4 rounded">
        <div class="row">
            <div class="col-md-6">
                ...
                <a href="../View/inscription.php" class="btn btn-primary btn-lg">Créer un Compte</a>
            </div>
            <div class="col-md-6 text-center">
                <img src="../assets/img/logo.svg" alt="Logo FatFitness" class="img-fluid" style="max-width: 60%;">
            </div>
        </div>
    </section>
</div>
